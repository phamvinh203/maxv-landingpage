...
export default function RegisterSection() {
  return (
    <section
      className="relative overflow-hidden bg-[#0067e8] px-4 py-5 sm:px-6 lg:px-8"
      id="dang-ky"
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-5 md:grid-cols-[1fr_430px]">
        <div className="text-center md:text-left">
          <h2 className="text-xl font-extrabold leading-8 text-white sm:text-2xl">
            Bắt đầu chuyển đổi số kế toán cùng Maxx ngay hôm nay!
          </h2>
